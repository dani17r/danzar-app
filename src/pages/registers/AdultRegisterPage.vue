...
<template>
  <q-page class="flex flex-center">
    <q-card class="q-pa-md box-card-content" v-if="rolesStore.isActiveRegister['adult']">
      <q-card-section class="text-center">
        <div class="text-grey-9 text-h4 text-weight-bold">Registro de {{ rolesStore.info['adult'] }}</div>
