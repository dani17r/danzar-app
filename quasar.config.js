...
module.exports = configure(function (ctx) {
  return {
    ...
    bin: {
      linuxAndroidStudio: '/home/core/android-studio/bin/studio.sh',
    },
    link: {
      // Configuración para abrir la aplicación de Quasar
      quasar: {
        // URL de la aplicación de Quasar
        url: 'quasar://reset-password',
      },
    },
  };
});
